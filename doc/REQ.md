...
**系統背景與目的**：
本系統旨在取代傳統紙本或機器打卡，建置一套**數位化、可即時回饋**的員工考勤與假單管理平台，並提供主管有效率的後台管理工具。
系統包含 **前台（員工）** 以及 **後台（主管）**，使用統一架構樣板進行開發，確保界面一致性與資料庫完整性。
...
| **FR-03** | 顯示打卡紀錄        | 員工／主管 | 員工僅能查看自己的紀錄；主管可查看全部員工出勤。      |
| **FR-04** | 請假申請          | 員工    | 員工提出請假申請，可查看假別、日期、審核狀態。       |
| **FR-05** | 請假審核          | 主管    | 主管可核准／退回假單，結果需通知員工。           |
| **FR-06** | 匯出打卡紀錄（Excel） | 主管    | 可將員工打卡紀錄匯出成 Excel。            |
| **FR-07** | 出勤異常提醒        | 員工／主管 | 若員工未打卡、遲到，系統會通知主管與該員工。        |
